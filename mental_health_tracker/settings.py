...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "jeremia-rangga-mentalhealthtracker.pbp.cs.ui.ac.id"]
...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","jeremia-rangga-mentalhealthtracker.pbp.cs.ui.ac.id"]
